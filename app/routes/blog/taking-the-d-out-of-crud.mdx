...
Check out the [next post in this series](/blog/taking-the-d-out-of-crud-with-soft-updates), where we go one step further by extending this concept to soft updates.
